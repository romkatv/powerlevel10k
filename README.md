...
| `⇣42`     | this means commits behind the remote                                  | `git status --ignore-submodules=dirty`                 |
| `⇡42`     | this means commits ahead of the remote                                | `git status --ignore-submodules=dirty`                 |
| `⇠42`     | this means commits behind the push remote                             | `git rev-list --left-right --count HEAD...@{push}`     |
| `⇢42`     | this means commits ahead of the push remote                           | `git rev-list --left-right --count HEAD...@{push}`     |
| `*42`     | this means stashes                                                    | `git stash list`                                       |
