# Generated by Powerlevel10k configuration wizard on 2020-02-08 at 10:23 CET.
...
# solid, full frame, light-ornaments, compact, many icons, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local    stashes='%F'    # default foreground
      #local       meta='%f'     # default foreground
      #local      clean='%10F'   # lightgreen foreground
      #local   modified='%11F'   # lightyellow foreground
      #local  untracked='%12F'   # lightblue foreground
      #local conflicted='%9F'    # lightred foreground
      #local    stashes='%13F'   # lightmagenta foreground
    else
      ...
      local    stashes='%244F'  # grey foreground
    fi
    ...
    (( VCS_STATUS_STASHES        )) && res+=" ${stashes}$(print_icon 'VCS_STASH_ICON')${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    #[[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    #(( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}~${VCS_STATUS_NUM_CONFLICTED}"
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}$(echo '\uE727')${VCS_STATUS_NUM_CONFLICTED}"   # '\uF421 ' <- TRIANGLE ||  '\uE727' <- merge 
  ...
  #typeset -g POWERLEVEL9K_VCS_STASHED_FOREGROUND=13
  
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=8       # grigio
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=10        # green
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=11     # yellow
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=12    # blue
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=9    # red
  typeset -g POWERLEVEL9K_VCS_STASHED_BACKGROUND=13      # magenta
